<template>
	<div class="container">
		...
		<div class="listTop"><p class="tCenter col9">相互借承诺你的信息安全</p></div>
		<ul class="mustInfo">
		...
		<div class="btnWarp">
			<span class="subBtn" :class='{grayBg:!checked}' @click="goApply">加入我们</span>
		</div>
...
<script>
	export default {
	    data () {
	        return {
	        	...
	        	//	{icon:'icon03',isLock:true,isOk:false,step:'第三步',tit:'紧急联系人',param:'userContacts',push:'/credit/contacts',err:'请填写紧急联系人'},
	        		{icon:'icon04',isLock:true,isOk:false,step:'第三步',tit:'手机认证',param:'userPhone',push:'/credit/mobile',err:'请进行手机认证'}
	    ...
	    //		else if(this.lists[4].isOk == false)	this.callDialog(this.lists[4].err);
	    			...
	    			//暂代
	    			this.$router.push('/loan/submitPool');
	    		}
	    	},
	        showClass(arr){
