<template>
<div class="container">
	<topComponent title='相互借' :showLeft='false'></topComponent>
	<dl class="userInfo">
		<dt>
			<p class="user-logo"></p>
			<p class="user-tel">秦廷双<span>{{data.userMobile | filterPhone}}</span></p>
			<p class="user-tag">
	...
	export default {
	    data () {
	        return {
	        	data:{},
	        	items:[
              {cls:"icon-fund",	push:"/loan/poolInfo",	tit:"我的资金池"},
