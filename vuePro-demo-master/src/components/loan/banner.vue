		...
		data(){
			return {
				lists:[
					...
					{tit:'',img:'./static\\img\\loanBanner2.2bd63e8.jpg',isOn:false},
         // {tit:'',url: require("static\\img\\loanBanner2.2bd63e8.jpg"),isOn:false},
					{tit:'',img:'https://cgtzimage.b0.upaiyun.com/191810/00/00/42/2016/10/21/AB697121-9758-072D-0C6F-28711778485A.jpg',isOn:false}
				],
